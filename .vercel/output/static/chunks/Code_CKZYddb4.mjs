import { f as createAstro, g as createComponent, B as AstroUserError, r as renderTemplate, m as maybeRenderHead, i as addAttribute, j as renderComponent, n as renderSlot, u as unescapeHTML, k as Fragment, l as renderScript, s as spreadAttributes } from './astro_DiIWhFry.mjs';
import 'kleur/colors';
import { s as slugToLocaleData, u as urlToSlug, a as useTranslations, b as $$Icon, I as Icons, d as definitions } from './prerender_ChexKOdG.mjs';
/* empty css                                                            */
import 'clsx';
/* empty css                                                                */
/* empty css                                                            */
...
import './FileTree_astro_astro_type_style_index_0_lang.9990d851_l0sNRNKZ.mjs';
...
}, "E:/Works/Website/DCK/dating-app/node_modules/@astrojs/starlight/user-components/Aside.astro", void 0);
...
}, "E:/Works/Website/DCK/dating-app/node_modules/@astrojs/starlight/user-components/Card.astro", void 0);
...
}, "E:/Works/Website/DCK/dating-app/node_modules/@astrojs/starlight/user-components/CardGrid.astro", void 0);
...
const $$Tabs = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "starlight-tabs", "starlight-tabs", { "class": "astro-esqgolmp" }, { "default": () => renderTemplate` ${panels && renderTemplate`${maybeRenderHead()}<div class="tablist-wrapper not-content astro-esqgolmp"> <ul role="tablist" class="astro-esqgolmp"> ${panels.map(({ icon, label, panelId, tabId }, idx) => renderTemplate`<li role="presentation" class="tab astro-esqgolmp"> <a role="tab"${addAttribute("#" + panelId, "href")}${addAttribute(tabId, "id")}${addAttribute(idx === 0 && "true", "aria-selected")}${addAttribute(idx !== 0 ? -1 : 0, "tabindex")} class="astro-esqgolmp"> ${icon && renderTemplate`${renderComponent($$result, "Icon", $$Icon, { "name": icon, "class": "astro-esqgolmp" })}`} ${label} </a> </li>`)} </ul> </div>`} ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(html)}` })} ` })}  ${renderScript($$result, "E:/Works/Website/DCK/dating-app/node_modules/@astrojs/starlight/user-components/Tabs.astro?astro&type=script&index=0&lang.ts")}`;
}, "E:/Works/Website/DCK/dating-app/node_modules/@astrojs/starlight/user-components/Tabs.astro", void 0);
...
}, "E:/Works/Website/DCK/dating-app/node_modules/@astrojs/starlight/user-components/TabItem.astro", void 0);
...
}, "E:/Works/Website/DCK/dating-app/node_modules/@astrojs/starlight/user-components/LinkCard.astro", void 0);
...
}, "E:/Works/Website/DCK/dating-app/node_modules/@astrojs/starlight/user-components/Steps.astro", void 0);
...
}, "E:/Works/Website/DCK/dating-app/node_modules/@astrojs/starlight/user-components/FileTree.astro", void 0);
...
async function createRenderer() {
  const { astroConfig, ecConfigFileOptions, ecIntegrationOptions = {} } = await import('./config_BdMlhzdO.mjs');
  ...
  try {
    const { default: preprocessEcConfig } = await import('./preprocess-config_CIC99ddb.mjs');
...
${error.message}`, { cause: error });
  ...
  return renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(html)}` })}`;
}, "E:/Works/Website/DCK/dating-app/node_modules/astro-expressive-code/components/Code.astro", void 0);
