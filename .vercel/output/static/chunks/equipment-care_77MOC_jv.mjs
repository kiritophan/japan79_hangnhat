const id = "tools/equipment-care.mdx";
						...
						const data = {title:"Equipment Care & Maintenance",description:"Explore ScrewFast's comprehensive documentation for an in-depth look at our premium tools and construction services.",editUrl:true,head:[],template:"doc",sidebar:{order:2,label:"Equipment Care",hidden:false,attrs:{}},pagefind:true};
						const _internal = {
							type: 'content',
							filePath: "E:/Works/Website/DCK/dating-app/src/content/docs/tools/equipment-care.mdx",
							rawData: undefined,
						};
