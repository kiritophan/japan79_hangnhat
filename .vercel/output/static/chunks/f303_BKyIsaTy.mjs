const id = "f303.md";
						...
						new Proxy({"src":"/_astro/product-image-4.D9xSELbd.avif","width":1458,"height":1042,"format":"avif","fsPath":"E:/Works/Website/DCK/dating-app/src/images/product-image-4.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "E:/Works/Website/DCK/dating-app/src/images/product-image-4.avif";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("E:/Works/Website/DCK/dating-app/src/images/product-image-4.avif");
							return target[name];
						}
					})
					,imgMain:
						new Proxy({"src":"/_astro/product-image-main-4.Bkgr1GB5.avif","width":1737,"height":1151,"format":"avif","fsPath":"E:/Works/Website/DCK/dating-app/src/images/product-image-main-4.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "E:/Works/Website/DCK/dating-app/src/images/product-image-main-4.avif";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("E:/Works/Website/DCK/dating-app/src/images/product-image-main-4.avif");
							return target[name];
						}
					})
					...
					,second:
						...
						const _internal = {
							type: 'content',
							filePath: "E:/Works/Website/DCK/dating-app/src/content/products/f303.md",
							rawData: undefined,
						};
