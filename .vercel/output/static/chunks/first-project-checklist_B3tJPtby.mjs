const id = "ja/guides/first-project-checklist.mdx";
						...
						const data = {title:"ファーストプロジェクトチェックリスト",description:"ScrewFastの包括的なドキュメントを探索して、プレミアムツールと建設サービスを詳しく見てください。",editUrl:true,head:[],template:"doc",sidebar:{order:3,label:"First Project Checklist",hidden:false,attrs:{}},pagefind:true};
						const _internal = {
							type: 'content',
							filePath: "E:/Works/Website/DCK/dating-app/src/content/docs/ja/guides/first-project-checklist.mdx",
							rawData: undefined,
						};
