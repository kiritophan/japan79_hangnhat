const id = "ja/guides/intro.mdx";
						...
						const data = {title:"はじめに",description:"ScrewFastの包括的なドキュメントを探索して、プレミアムツールと建設サービスを詳しく見てください。",editUrl:true,head:[],template:"doc",sidebar:{order:2,label:"Introduction to Services",hidden:false,attrs:{}},pagefind:true};
						const _internal = {
							type: 'content',
							filePath: "E:/Works/Website/DCK/dating-app/src/content/docs/ja/guides/intro.mdx",
							rawData: undefined,
						};
