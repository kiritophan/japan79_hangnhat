const id = "construction/service-overview.mdx";
						...
						const data = {title:"Comprehensive Service Overview",description:"Explore ScrewFast's comprehensive documentation for an in-depth look at our premium tools and construction services.",editUrl:true,head:[],template:"doc",sidebar:{order:1,label:"Service Overview",hidden:false,attrs:{}},pagefind:true};
						const _internal = {
							type: 'content',
							filePath: "E:/Works/Website/DCK/dating-app/src/content/docs/construction/service-overview.mdx",
							rawData: undefined,
						};
